    ...
    <div className="min-h-screen bg-[#FDF6EC] pt-24 pb-12">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 border-b-[3px] border-black pb-8">
          <div>
            <h1 className="text-4xl md:text-5xl font-black text-black mb-3 tracking-tight">Products</h1>
          ...
          <button
            ...
            className="flex items-center gap-2 px-8 py-3 bg-[#B4F056] border-[3px] border-black font-black uppercase text-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 transition-all text-black"
          >
        ...
        {/* Products Grid */}
        {products.length === 0 ? (
          <div className="text-center py-20 border-[3px] border-black bg-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-xl">
            <div className="w-20 h-20 bg-[#FFD93D] rounded-full border-[3px] border-black flex items-center justify-center mx-auto mb-6">
              <Package className="w-10 h-10 text-black" strokeWidth={2.5} />
            </div>
            <h3 className="text-2xl font-black text-black mb-2">No Products Yet</h3>
            <p className="text-black/60 font-medium mb-8">
              Add your first product to get started
            </p>
            <button
              onClick={() => setShowForm(true)}
              className="inline-flex items-center gap-2 px-8 py-3 bg-[#B4F056] border-[3px] border-black font-black uppercase shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all text-black"
            >
              <Plus className="w-5 h-5" strokeWidth={3} />
              Add Product
            </button>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {products.map((product) => (
              <div
                key={product.id}
                className="bg-white border-[3px] border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 transition-all overflow-hidden group"
              >
                {/* Image */}
                <div className="aspect-[4/5] bg-gray-100 relative border-b-[3px] border-black">
                  ...
                  {!product.active && (
                    <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                      <span className="bg-red-500 text-white px-3 py-1 font-black text-sm uppercase flex items-center gap-1 border-2 border-black transform -rotate-12 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                  ...
                  {/* Try-On indicator */}
                  {product.tryon_image && (
                    <div className="absolute top-2 right-2 bg-[#FF6B35] text-white px-2 py-1 text-[10px] font-black flex items-center gap-1 border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
                      <Shirt className="w-3 h-3" strokeWidth={3} />
                      TRY-ON
                    </div>
                  )}
                </div>
                ...
                {/* Content */}
                <div className="p-5">
                  <h3 className="font-black text-xl mb-2 truncate leading-tight">{product.name}</h3>
                  <div className="flex items-center flex-wrap gap-2 text-sm text-black mb-4">
                    {product.category && (
                      <span className="bg-[#E5E7EB] px-2 py-1 font-bold border-2 border-black text-xs uppercase">
                        {product.category}
                      </span>
                    )}
                    {product.price && (
                      <span className="font-black text-lg bg-[#B4F056] px-2 py-0.5 border-2 border-black -skew-x-6">₹{product.price}</span>
                    )}
                  </div>
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 py-2.5 border-2 border-black font-black text-xs uppercase hover:bg-[#FFD93D] transition-colors flex items-center justify-center gap-1.5 bg-white"
                    >
                    ...
                    {product.link && (
                      <a
                        ...
                        className="p-2.5 border-2 border-black hover:bg-[#6EC1E4] transition-colors bg-white flex items-center justify-center"
                      >
                    ...
                    <button
                      ...
                      className="p-2.5 border-2 border-black hover:bg-red-500 hover:text-white transition-colors bg-white flex items-center justify-center"
                    >
