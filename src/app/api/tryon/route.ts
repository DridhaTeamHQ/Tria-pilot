...
const TRYON_VARIANTS = [
  { suffix: 'A', label: 'Option 1', nudge: 'Variant A: keep the composition clean, balanced, and product-focused.' },
  { suffix: 'B', label: 'Option 2', nudge: 'Variant B: keep the same identity and outfit, but introduce a slightly more dynamic premium fashion composition.' },
  { suffix: 'C', label: 'Option 3', nudge: 'Variant C: keep the same identity and outfit, but deliver a polished campaign-ready variation with subtle scene energy.' },
] as const
