  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="group relative overflow-hidden rounded-2xl border-[3px] border-black bg-white p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all hidden sm:block"
      >
