  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          <div
            className="relative my-auto flex max-h-[min(92dvh,920px)] w-full max-w-[min(94vw,1220px)] flex-col overflow-hidden rounded-[30px] border-[3px] border-black bg-[linear-gradient(180deg,#FFFDF8_0%,#FFF7EC_100%)] shadow-[12px_12px_0px_0px_rgba(0,0,0,0.9)]"
          ...
          >
            ...
            <div className="relative flex min-h-0 flex-1 items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,#fff7ea_0%,#ffeccd_42%,#f4dcc0_100%)] p-4 sm:p-6">
              ...
              <Image
                ...
                height={1600}
                unoptimized
                className="relative z-10 max-h-[calc(min(92dvh,920px)-148px)] max-w-full rounded-[24px] border-[3px] border-black bg-white object-contain shadow-[0_28px_80px_rgba(0,0,0,0.24)]"
              />
            </div>
