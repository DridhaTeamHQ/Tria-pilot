...
const FUN_FACTS = [
  "Did you know? The first virtual try-on tech was patented in 1998.",
  "AI analyzes over 40 distinct depth points to understand fabric drape.",
  "We rank photos using a semantic matrix scoring over 100 features.",
  "Inpainting networks blend the existing lighting to match the new garment.",
  "This operation runs through a 4-stage pipeline for maximum fidelity.",
  "Running locally ensures single-pass generations remain strictly isolated.",
  "Almost there! Generating high-resolution details and micro-textures.",
  "Did you know? We process one source at a time to prevent identity drift.",
]
...
export function MonaLisaGenerationLoader({
  ...
  const factIndex = Math.floor(elapsedSeconds / 4) % FUN_FACTS.length
      ...
      <div className="grid gap-6 lg:grid-cols-[220px_minmax(0,1fr)] lg:items-center">
        ...
        <div className="space-y-4">
          <div>
            ...
            {/* The Fun Fact Cycler! */}
            <div className="mt-2 min-h-[40px] max-w-2xl text-sm font-bold text-black/80 transition-opacity duration-300">
              <span className="text-black/50 font-semibold mr-1">While you wait:</span> {currentFact}
            </div>
          </div>
