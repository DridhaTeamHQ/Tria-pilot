...
const CINEMATIC_PRESETS: ScenePreset[] = [
  {
    ...
    category: 'outdoor',
    region: 'global',
    scene: 'Empty stadium grandstand with rows of colored plastic seats, deep symmetrical perspective, repeating grid pattern.',
    lighting: 'Natural diffused daylight with soft shadows, cool ambient from open sky, even illumination across seat rows. 5500-6000K cool neutral.',
    camera: '85mm f/2.0, centered medium-full shot from slightly above eye level, deep perspective vanishing point.',
    motion: 'static',
    mood: 'candid',
    style: 'realism',
    negative_bias: 'No crowds, no field visible, no harsh direct sun, no warm cast, no cluttered seats.',
    scenes: [
      { id: 'blue_seats', scene: 'Empty stadium grandstand of cobalt-blue molded plastic seats with white seat numbers, strong symmetrical grid creating deep one-point perspective, subject dead center with rows of seats behind.', bestFor: 'editorial fashion, cool-toned content, structured outfits' },
      { id: 'red_seats', scene: 'Empty arena with deep red plastic stadium seats, brushed concrete steps between rows, dramatic symmetrical perspective, industrial sports architecture.', bestFor: 'bold garments, warm accents, sporty-luxe styling' },
      { id: 'mixed_seats', scene: 'Weathered outdoor stadium with alternating faded blue, yellow, green seat blocks, concrete terracing with paint chips and aging patina, nostalgic sports-ground atmosphere.', bestFor: 'vintage styling, retro content, textured casual wear' },
    ],
    cameras: [
      { id: 'centered_above', camera: '85mm f/2.0, centered medium-full from slightly above eye level, ISO 200, symmetrical composition with deep vanishing point.', bestFor: 'editorial portraits, symmetry emphasis' },
      { id: 'low_angle_rows', camera: '35mm f/4.0, low angle looking up with seat rows creating dramatic leading lines, full body with scale.', bestFor: 'full body originals, powerful poses' },
      { id: 'side_profile', camera: '135mm f/2.8, compressed side profile with blurred seat grid creating graphic bokeh, tight crop.', bestFor: 'close-up originals, profile shots' },
    ],
    colorGrades: [
      { id: 'cool_blue', grade: 'Cool blue-dominant palette at 6000K, desaturated background, crisp focus, clean modern grading with subtle filmic texture.', bestFor: 'cool skin tones, blue/black garments' },
      { id: 'warm_contrast', grade: 'Warm-cool contrast with warm skin against cool blue seats, punchy micro-contrast, editorial processing.', bestFor: 'warm skin tones, red accent garments' },
      { id: 'faded_film', grade: 'Faded analog film with lifted blacks, muted seat colors, visible grain, nostalgic sports documentary quality.', bestFor: 'vintage styling, muted colors' },
    ],
  },
  {
    id: 'nyc_nightlife',
    ...
    category: 'street',
    region: 'global',
    scene: 'Busy NYC street at night outside a trendy venue, neon signs, taxi headlights, lively urban atmosphere.',
    lighting: 'Mixed neon and streetlight sources casting colored pools, warm incandescent from venue spilling onto sidewalk, passing headlights. Mixed 2800-5500K.',
    camera: '50mm f/1.4, shallow depth with neon and headlight bokeh circles, cinematic night quality.',
    motion: 'subtle motion',
    mood: 'candid',
    style: 'realism',
    negative_bias: 'No daytime, no empty streets, no harsh flash, no oversaturated neon, no fake rain.',
    scenes: [
      { id: 'pub_exterior', scene: 'Trendy pub entrance on NYC sidewalk at night, warm light spilling from doorway, neon beer signs in window, people waiting outside, taxis passing in background, busy urban energy.', bestFor: 'nightlife content, party outfits, urban style' },
      { id: 'corner_neon', scene: 'NYC street corner at night with glowing neon signage in red and blue, wet pavement reflecting colored lights, yellow cab passing, steam from subway grate, blurred pedestrians.', bestFor: 'edgy styling, streetwear, cinematic mood' },
      { id: 'cafe_window', scene: 'Late-night NYC cafe storefront with warm golden interior through large window, condensation on glass, outdoor bistro table, distant traffic lights and building glow.', bestFor: 'casual elegant, warm mood, intimate night' },
    ],
    cameras: [
      { id: 'night_portrait', camera: '50mm f/1.4, three-quarter portrait, ISO 800, 1/125s, circular neon bokeh creating depth layers.', bestFor: 'half-body originals, bokeh background' },
      { id: 'street_wide', camera: '35mm f/2.0, full body on sidewalk with visible venue and passing traffic, cinematic street framing.', bestFor: 'full body originals, environmental storytelling' },
      { id: 'candid_walk', camera: '85mm f/1.8, compressed street shot with blurred pedestrians and streaked headlights, subject sharp.', bestFor: 'walking originals, dynamic energy' },
    ],
    colorGrades: [
      { id: 'neon_cinematic', grade: 'Cinematic neon night with teal shadows, warm amber skin, neon color accents, deep rich blacks, film grain.', bestFor: 'all skin tones, nightlife content' },
      { id: 'warm_tungsten', grade: 'Warm tungsten night at 3200K, golden skin, cool blue street shadows, classic night photography split.', bestFor: 'warm skin tones, intimate night' },
      { id: 'desaturated_noir', grade: 'Desaturated urban noir, muted neon, lifted grey shadows, strong contrast, moody street aesthetic.', bestFor: 'dark outfits, moody styling' },
    ],
  },
  {
    ...
    category: 'lifestyle',
    region: 'global',
    scene: 'Upscale outdoor Italian restaurant at night, wooden terrace, warm candlelight, blurred diners in background.',
    lighting: 'Warm overhead restaurant lighting mixed with candlelight, top-down and slightly from side creating soft hair highlights. 2800-3500K warm incandescent.',
    camera: '35mm f/1.8, medium close-up, shallow depth with warm bokeh from distant table candles.',
    motion: 'static',
    mood: 'candid',
    style: 'realism',
    negative_bias: 'No bright daylight, no empty table, no cluttered table, no harsh flash, no cold lighting.',
    scenes: [
      { id: 'terrace_dining', scene: 'Upscale outdoor Italian restaurant terrace at night, wooden pergola with warm string lights, candlelit white-linen table, blurred warm ambient lights and diners in distance, romantic evening.', bestFor: 'elegant evening wear, romantic content' },
      { id: 'indoor_trattoria', scene: 'Cozy indoor Italian trattoria with exposed brick walls, wine bottles on wooden shelves, flickering candle on checkered tablecloth, warm amber lighting, rustic atmosphere.', bestFor: 'casual dining content, rustic styling' },
      { id: 'courtyard_garden', scene: 'Hidden courtyard restaurant with climbing ivy on stone walls, iron lanterns casting warm pools, cobblestone floor, fountain in background, starlit sky above.', bestFor: 'formal evening wear, magical mood' },
    ],
    cameras: [
      { id: 'dining_close', camera: '35mm f/1.8, medium close-up centered, ISO 400, warm bokeh from candles and string lights behind.', bestFor: 'close-up originals, intimate framing' },
      { id: 'seated_mid', camera: '50mm f/2.0, three-quarter seated with visible table setting and restaurant environment.', bestFor: 'half-body originals, dining lifestyle' },
      { id: 'entrance_full', camera: '28mm f/2.8, full body near restaurant entrance with warm interior glow behind.', bestFor: 'full body originals, arrival shots' },
    ],
    colorGrades: [
      { id: 'candlelight_warm', grade: 'Warm candlelight at 2800K, golden skin glow, rich amber highlights, soft warm shadows, subtle film grain.', bestFor: 'all skin tones, romantic ambiance' },
      { id: 'trattoria_cozy', grade: 'Cozy trattoria at 3200K, warm orange-amber tones, deep burgundy shadows, rich saturated warmth.', bestFor: 'warm skin tones, rustic styling' },
      { id: 'evening_elegant', grade: 'Elegant evening at 3500K, refined warm tones, gentle contrast, creamy highlights, polished quality.', bestFor: 'formal styling, luxury content' },
    ],
  },
  {
    id: 'urban_film_street',
    label: 'Urban Film Street',
    category: 'street',
    region: 'global',
    scene: 'Stone-paved urban street with directional light, blurred figures in motion, film grain texture, muted nostalgic tones.',
    lighting: 'Soft directional light from side creating warm nostalgic glow with diffuse shadows, filtered through urban corridor. 4800-5500K mixed natural.',
    camera: '50mm f/2.0, high-angle or eye-level medium shot, grainy film texture, contemplative framing.',
    motion: 'subtle motion',
    mood: 'candid',
    style: 'realism',
    negative_bias: 'No harsh noon sun, no clean digital look, no oversaturated colors, no empty streets, no artificial smoothness.',
    scenes: [
      { id: 'stone_street', scene: 'Stone-paved narrow street with worn cobblestones, blurred pedestrians in motion suggesting bustle, old building facades with patina, soft directional light casting warm nostalgic glow.', bestFor: 'muted outfits, vintage styling, contemplative content' },
      { id: 'market_morning', scene: 'Morning market street with old awnings and hand-painted shop signs, vendors in soft focus, wet pavement from morning wash, dappled light through canvas canopies.', bestFor: 'casual wear, cultural content, morning atmosphere' },
      { id: 'alley_golden', scene: 'Narrow urban alley with textured plaster walls in muted ochre and terracotta, iron balconies overhead, golden directional light cutting through at steep angle, strong shadows.', bestFor: 'warm outfits, Mediterranean mood, dramatic light' },
    ],
    cameras: [
      { id: 'high_angle', camera: '50mm f/2.0, high-angle medium shot looking down, street context around subject, contemplative perspective.', bestFor: 'standing originals, unique perspective' },
      { id: 'street_level', camera: '35mm f/2.8, eye-level candid with blurred walking figures, film composition with subject off-center.', bestFor: 'casual originals, candid street feel' },
      { id: 'compressed_tele', camera: '135mm f/2.0, telephoto with flattened perspective, subject isolated from busy blurred street.', bestFor: 'close-up originals, editorial emphasis' },
    ],
    colorGrades: [
      { id: 'nostalgic_film', grade: 'Muted nostalgic film with desaturated greens and blues, warm skin, visible grain, lifted blacks, timeless mood.', bestFor: 'all skin tones, vintage content' },
      { id: 'warm_analog', grade: 'Warm analog at 4500K, golden-amber cast, faded saturation, heavy grain, Kodak Gold aesthetic.', bestFor: 'warm skin tones, retro feel' },
      { id: 'cool_documentary', grade: 'Cool documentary at 5800K, desaturated palette, blue-green shadows, fine grain, photojournalistic authenticity.', bestFor: 'cool skin tones, documentary mood' },
    ],
  },
  {
    id: 'rooftop_evening',
    ...
    category: 'lifestyle',
    region: 'global',
    scene: 'Rooftop bar or lounge at dusk with city lights twinkling below, warm string lights, cocktail atmosphere.',
    lighting: 'Warm string lights overhead mixed with deep blue dusk sky ambient, city glow from below providing fill. Mixed 2800-5000K warm-cool.',
    camera: '50mm f/1.8, three-quarter with city lights bokeh, golden-to-blue hour transition.',
    motion: 'static',
    mood: 'candid',
    style: 'realism',
    negative_bias: 'No daytime bright, no empty industrial roof, no AC units, no harsh flash, no flat sky.',
    scenes: [
      { id: 'bar_dusk', scene: 'Rooftop bar at blue-hour with Edison-bulb string lights overhead, teak furniture with cushions, cocktail on metal table, city skyline with emerging lights, sky from amber to cobalt blue.', bestFor: 'evening lifestyle, cocktail content' },
      { id: 'lounge_sunset', scene: 'Rooftop lounge with low modern furniture, potted palms, last golden light on concrete deck, dramatic shadows, city beginning to glow below.', bestFor: 'golden hour content, relaxed styling' },
      { id: 'party_night', scene: 'Rooftop party with decorative lanterns and fairy lights, DJ booth glow in distance, people socializing in soft focus, city panorama at night.', bestFor: 'party outfits, nightlife content' },
    ],
    cameras: [
      { id: 'cityscape_portrait', camera: '50mm f/1.8, three-quarter portrait with layered city light bokeh, warm-cool mixed lighting on face.', bestFor: 'half-body originals, city backdrop' },
      { id: 'wide_atmosphere', camera: '28mm f/2.8, full body with rooftop setting, string lights above, city panorama behind.', bestFor: 'full body originals, travel content' },
      { id: 'intimate_close', camera: '85mm f/1.4, tight portrait with blurred city bokeh circles, intimate evening quality.', bestFor: 'close-up originals, dreamy portraits' },
    ],
    colorGrades: [
      { id: 'blue_hour', grade: 'Blue hour dusk at 5000K, deep blue sky, warm string light accents, balanced skin, cinematic evening quality.', bestFor: 'all skin tones, dusk content' },
      { id: 'golden_last_light', grade: 'Last golden light at 3500K, warm amber glow, deep warm shadows, sun-kissed evening warmth.', bestFor: 'warm skin tones, golden hour' },
      { id: 'night_glamour', grade: 'Night glamour with rich deep blacks, warm highlight accents, high contrast, sparkling city lights.', bestFor: 'evening wear, glamorous styling' },
    ],
  },
]
