...
const STUDIO_PRESETS: ScenePreset[] = [
  {
    ...
    category: 'lifestyle',
    region: 'global',
    scene: 'Professional photo studio with seamless white cyclorama, curved infinity wall creating a shadowless horizon, polished white epoxy floor with subtle reflections.',
    lighting: 'Key: large 4-foot softbox positioned front-left at 45 degrees creating soft, wrap-around illumination. Fill: matched softbox front-right at 1-stop lower power for gentle shadow fill. Rim: overhead silk diffusion panel providing delicate edge separation. Color temperature precisely 5400-5600K neutral daylight.',
    camera: '85mm f/1.8 portrait lens, chest-up to full-body framing with subject at optimal distance.',
    motion: 'static',
    mood: 'candid',
    style: 'realism',
    negative_bias: 'No colored gels, no harsh contrasty shadows, no visible stands or cables, no oversaturation, no plastic skin texture, no beauty filter smoothing.',
    scenes: [
      { id: 'infinity_wall', scene: 'Seamless white cyclorama with curved infinity wall, polished white epoxy floor with subtle reflections, absolutely clean with a smooth tonal gradient from pure white center to light grey edges.', bestFor: 'clean product-focused shots, formal attire, professional headshots' },
      { id: 'textured_white', scene: 'White studio with subtle hand-troweled plaster wall texture, matte white concrete floor showing natural aggregate pattern, clean but with physical material presence.', bestFor: 'casual wear, lifestyle brand shots, textured garments' },
      { id: 'high_key', scene: 'Bright high-key white studio with luminous wrap-around light, floor-to-ceiling white panels, ethereal glow with minimal shadow definition.', bestFor: 'light skin tones, delicate fabrics, feminine styling' },
    ],
    cameras: [
      { id: 'portrait_tight', camera: '85mm f/1.8, chest-up tight portrait framing with clean backdrop falloff. Sharp focus on eyes.', bestFor: 'headshot or close-up original photos' },
      { id: 'three_quarter', camera: '50mm f/2.8, three-quarter body framing from knees up with full garment visibility. Medium depth.', bestFor: 'half-body original photos showing torso' },
      { id: 'full_body', camera: '35mm f/4.0, full body head-to-toe framing with complete outfit visibility and studio context.', bestFor: 'full body original photos, outfit-focused content' },
    ],
    colorGrades: [
      { id: 'neutral_clean', grade: 'Neutral 5500K color balance, no color cast, true whites, accurate skin reproduction.', bestFor: 'all skin tones, product-accurate color representation' },
      { id: 'warm_cream', grade: 'Slightly warm 5000K with cream undertones, soft warm highlights, flattering skin warmth.', bestFor: 'warm skin tones, golden undertones, earth-tone garments' },
      { id: 'cool_editorial', grade: 'Cool 6000K with crisp blue-white tones, high contrast, fashion editorial punch.', bestFor: 'cool skin tones, bold colors, editorial styling' },
    ],
  },
  {
    id: 'studio_cream',
    ...
    category: 'lifestyle',
    region: 'global',
    scene: 'Warm cream seamless paper backdrop with visible paper grain and natural fiber texture, matte concrete floor with scuff variation.',
    lighting: 'Key: broad 3-foot diffused source from camera-left creating gentle directional modeling. Fill: cream wall bounce on camera-right preserving shadow detail. Rim: gentle overhead spill creating subtle shoulder separation. Warm-neutral 4800-5100K.',
    camera: '85mm f/2.0 portrait lens, three-quarter framing.',
    motion: 'static',
    mood: 'candid',
    style: 'realism',
    negative_bias: 'No cool blue cast, no hard specular flash, no clipped highlights on cheekbones, no heavy orange grade, no synthetic bokeh.',
    scenes: [
      { id: 'paper_roll', scene: 'Cream seamless paper backdrop with visible paper roll curvature at floor transition, matte concrete floor with authentic scuff marks, warm intimate studio feel.', bestFor: 'portraits, casual wear, warm lighting' },
      { id: 'linen_wall', scene: 'Natural linen fabric backdrop in warm ecru tone with visible weave texture, aged wooden floorboards with patina, artisan studio aesthetic.', bestFor: 'textured garments, knitwear, bohemian styling' },
      { id: 'warm_plaster', scene: 'Hand-applied venetian plaster wall in warm sand tone with subtle trowel marks and imperfections, polished concrete floor, Mediterranean atelier feeling.', bestFor: 'luxury garments, warm skin tones, elevated casual' },
    ],
    cameras: [
      { id: 'beauty_close', camera: '100mm f/2.0 tight beauty framing, head and shoulders with soft backdrop falloff and paper texture visible.', bestFor: 'close-up headshot originals, jewelry-focused' },
      { id: 'lifestyle_mid', camera: '50mm f/2.8 mid-body framing from waist up showing garment details and backdrop texture.', bestFor: 'half-body originals, top-focused outfits' },
      { id: 'full_editorial', camera: '35mm f/3.5 full body editorial framing with floor texture visible and complete outfit.', bestFor: 'full body originals, complete outfit display' },
    ],
    colorGrades: [
      { id: 'warm_film', grade: 'Warm analog film tone with lifted blacks, soft highlight roll-off, golden 4800K warmth, Kodak Portra-like skin.', bestFor: 'warm skin tones, earth-tone garments, vintage aesthetic' },
      { id: 'neutral_soft', grade: 'Neutral balanced exposure with soft contrast, true-to-life colors, natural skin rendering at 5200K.', bestFor: 'all skin tones, accurate garment color display' },
      { id: 'matte_fade', grade: 'Slightly desaturated matte look with faded blacks, subtle warm cast, magazine editorial processing.', bestFor: 'editorial styling, muted color palettes, pastel garments' },
    ],
  },
  {
    id: 'studio_editorial',
    ...
    category: 'lifestyle',
    region: 'global',
    scene: 'High-end editorial studio with white painted brick wall showing authentic texture, polished concrete floor, sparse architectural styling.',
    lighting: 'Key: large diffused directional window-style source from frame-left creating sculptural modeling. Fill: controlled white card bounce preserving skin detail. Rim: narrow overhead strip light for contour separation. Daylight 5300-5600K.',
    camera: '85-100mm f/2.8 editorial framing with clean geometry.',
    motion: 'static',
    mood: 'candid',
    style: 'realism',
    negative_bias: 'No cluttered props, no visible strobes, no harsh direct flash, no excessive sharpening, no fake gaussian blur.',
    scenes: [
      { id: 'brick_minimal', scene: 'White painted brick wall with authentic mortar lines and texture variation, polished concrete floor with aggregate pattern, spare architectural geometry with intentional negative space.', bestFor: 'structured garments, formal wear, strong silhouettes' },
      { id: 'concrete_arch', scene: 'Raw poured concrete wall with form-tie marks and natural imperfections, steel-framed arched doorway creating geometric frame, smooth sealed concrete floor, industrial-chic editorial space.', bestFor: 'streetwear, contemporary fashion, bold patterns' },
      { id: 'gallery_clean', scene: 'Museum-white gallery wall with track lighting overhead, pale oak hardwood floor, architectural column visible at frame edge, art-gallery minimalism.', bestFor: 'luxury fashion, clean designs, monochrome outfits' },
    ],
    cameras: [
      { id: 'editorial_tight', camera: '100mm f/2.8 tight editorial crop, face and upper body with precise geometric composition.', bestFor: 'close-up originals, face-focused content' },
      { id: 'fashion_mid', camera: '85mm f/2.0 three-quarter fashion framing with architectural context visible, sharp garment detail.', bestFor: 'half-body originals, garment detail emphasis' },
      { id: 'full_standing', camera: '50mm f/4.0 full body standing with intentional negative space, architectural lines framing subject.', bestFor: 'full body originals, outfit showcase' },
    ],
    colorGrades: [
      ...
      { id: 'bw_editorial', grade: 'Rich black and white conversion with full tonal range, deep cinematic blacks, silver-gelatin quality, dramatic contrast.', bestFor: 'monochrome outfits, dramatic styling, artistic shots' },
    ],
  },
]
