...
Lighting: harsh direct Phone flash reflected off mirror, blown highlights, hard shadows, uneven exposure, visible grain, flash glare streaks. Aesthetic: raw mirror selfie, flash photography, unfiltered realism, imperfect framing, accidental composition.`,
  ...
  },
  {
    ...
    presetId: 'studio_white_wall_saree_shadow',
    ...
    fullPrompt: `Grainy yet bright editorial photograph based on the reference identity. The subject wears a sunflower-print yellow saree with a sleeveless retro blouse, styled with a long thick braid to the waist and gajra. The mood carries a romantic 90s-film energy with subtle natural wind in the braid and fabric. She stands against a solid white wall with strong upper-left directional light creating deep shadows and dramatic contrast. Preserve identity from reference, natural skin texture, and realistic fabric sheen. Keep the body natural with no reshaping or beautification.`,
    faceRule: 'Face 100% from reference; natural skin texture, no beautification or body reshaping.',
  ...
  {
    id: 'porsche_panamera_residential',
    name: 'Residential Porsche Panamera',
    presetId: 'street_porsche_panamera_residential',
    vibe: 'Relaxed luxury street realism. Warm late-afternoon residential light, clean attitude, believable car-and-subject integration.',
    scene: 'Residential street with a sleek black Porsche Panamera parked curbside, pine needles scattered on the pavement, a white van and dark sedan in the distance, and natural neighborhood spacing with no showroom styling.',
    lighting: 'Soft warm late-afternoon daylight with natural shadow falloff. The face, black clothing, pavement, and car paint all share the same light direction, reflection behavior, and ambient fill. Hood reflections remain realistic and readable.',
    poseNotes: 'High-angle full-body composition. Subject leans casually against the hood with hands in pockets, relaxed posture, confident but not over-posed. Model infers a natural street-luxury stance.',
    styleKeywords: ['Porsche Panamera', 'residential street', 'late afternoon', 'black leather jacket', 'urban realism', 'car reflections', 'high-angle full body'],
    fullPrompt: `Create a realistic high-angle full-body street photograph of the person from the uploaded reference image leaning casually against the hood of a sleek black Porsche Panamera on a residential street. Preserve the exact same face, identity, skin texture, facial proportions, and body proportions from the reference image. Wardrobe: black leather jacket over a black tank top, wide-leg black denim jeans, black leather shoes. Scene details: scattered pine needles on the pavement, modest residential surroundings, a white van and a dark sedan parked in the background. Lighting is soft warm late-afternoon daylight with realistic shadow falloff and coherent reflections across the car hood, clothing, skin, and pavement. Keep it candid, relaxed, and photorealistic. No beautification, no face reshaping, no fake background blur, no sticker edges, no warped reflections, no showroom CGI finish.`,
    negativePrompt: 'beauty filter, face reshape, jaw slimming, fake blur, portrait mode cutout, CGI showroom, warped car reflections, halo around subject, mismatched lighting, plastic skin',
    aspectRatio: 'portrait',
    camera: 'High-angle full-body street framing with moderate-deep focus',
    colorGrading: 'Warm-neutral late afternoon with natural black levels and realistic reflective surfaces.',
    faceRule: 'Keep face 100% identical to reference. No beautification or face geometry changes.',
  },
  {
  ...
  {
    id: 'ramen_booth_snapshot',
    name: 'Retro Ramen Booth Snapshot',
    presetId: 'street_ramen_booth_snapshot',
    vibe: 'Accidental Renaissance meets casual influencer phone snapshot. Warm, intimate, slightly chaotic restaurant energy.',
    scene: 'Dim retro Japanese restaurant booth with deep teal tufted seating, illuminated white calligraphy panels, a cluttered wood shelf with bottles and decor, green or marble tabletop, ramen bowl, drink glass, napkin, and lived-in table clutter.',
    lighting: 'Soft warm amber and orange ambient light from the illuminated panels dominates the scene. Mixed low-light restaurant conditions with slight phone-camera noise, diffused background, and sharp detail on the subject and ramen.',
    poseNotes: 'Medium close-up from a slightly high angle. Subject leans forward over the table, lifting a long strand of ramen with chopsticks. Sunglasses obscure the eyes. The bowl anchors the lower frame while the chopsticks form a strong vertical line.',
    styleKeywords: ['ramen', 'restaurant booth', 'accidental renaissance', 'phone snapshot', 'warm amber light', 'teal booth', 'food realism'],
    fullPrompt: `Create a realistic medium close-up phone snapshot of the person from the input portrait seated inside a dim retro Japanese restaurant booth while eating ramen. Preserve the exact face identity and natural facial structure from the reference. Scene details: deep teal tufted booth, illuminated white panels with black and red Japanese calligraphy, cluttered shelf details, deep green or marble tabletop, blue ramen bowl, folded napkin, crystal glass with dark drink, and subtle table clutter. The subject leans slightly forward, lifting a long noodle strand with wooden chopsticks above the bowl. Warm amber and orange ambient lighting should dominate, with realistic phone-camera grain, shallow but believable depth, sharp food detail, and no sticker effect.`,
    negativePrompt: 'beauty retouch, food-commercial polish, over-styled restaurant set, fake blur haze, sticker edges, neon overload, CGI food, over-sharpening, face change',
    aspectRatio: 'portrait',
    camera: 'iPhone-style 35mm equivalent medium close-up from slight high angle',
    colorGrading: 'Warm amber and deep teal with natural phone-camera contrast and restrained saturation.',
    faceRule: 'Preserve exact identity from the source portrait. No facial reshaping or beautification.',
  },
  {
    id: 'night_beach_rick_owens',
    name: 'Night Beach Streetwear',
    presetId: 'night_beach_streetwear',
    vibe: 'Dark beach candid with luxury streetwear and realistic low-light atmosphere.',
    scene: 'Night shoreline with dark sand, low surf, open horizon, and sparse distant practical light. Minimal composition focused on the subject and beach depth.',
    lighting: 'Low-light night ambience with subtle mixed practical spill and weak sand bounce. Deep blacks remain readable without fake moonlit spotlighting.',
    poseNotes: 'Natural standing or walking beach posture with full-body realism, relaxed attitude, and authentic weight distribution on sand.',
    styleKeywords: ['night beach', 'streetwear', 'balenciaga', 'rick owens', 'low light realism', 'dark shoreline'],
    fullPrompt: `Create a highly realistic night beach photograph of the person from the reference image wearing a Balenciaga t-shirt, Rick Owens shorts with long laces, and Rick Owens Ramones. Preserve exact identity and natural body proportions from the source image. The setting is a dark beach with low surf, sparse distant light, and natural shoreline depth. Keep the low-light atmosphere believable with subtle sensor noise, realistic shadow retention, and no fake blur, no pasted-on subject edges, and no blockbuster moonlight look.`,
    negativePrompt: 'daylight beach, fake moonbeam, over-stylized cinematic grade, synthetic blur, sticker edges, body reshape, CGI water, oversaturation',
    camera: 'Smartphone or compact digital night framing with natural perspective',
    colorGrading: 'Cool-neutral night tones with controlled blacks and restrained highlights.',
    faceRule: 'Identity must stay unchanged from reference with no beautification or face drift.',
  },
  {
    id: 'industrial_window_chair_editorial',
    name: 'Industrial Window Chair Editorial',
    presetId: 'studio_industrial_window_chair',
    vibe: 'Quiet fashion editorial with vintage film softness, industrial geometry, and strong daylight structure.',
    scene: 'Minimal industrial studio with matte white wall corner seam, raw gray concrete floor, and a vintage brown office chair with metal caster base. Subject sits on the right third with large negative space.',
    lighting: 'Strong left-side window daylight creates crisp geometric wall shadows and diagonal light streaks on the floor. Contrast is sharp but believable, with lifted blacks and soft vintage film character.',
    poseNotes: 'Wide shot. Subject reclines sideways in the brown office chair, one leg extended, barefoot, calm and pensive, looking frame-right. The composition depends on the chair type and right-third placement.',
    styleKeywords: ['industrial studio', 'window light', 'chair editorial', 'negative space', 'butter yellow satin', 'film grain'],
    fullPrompt: `Create an ultra-photoreal editorial fashion image of the reference person in a minimal industrial studio with a matte white corner wall and raw gray concrete floor. The subject is reclined sideways on a vintage brown office chair with a metal caster base, positioned on the right third of the frame with large negative space. Strong left-side window daylight casts crisp geometric shadows on the wall and diagonal light streaks across the floor. Wardrobe: pale butter-yellow satin slip dress with thin straps and natural satin folds. Preserve realistic skin texture, contact shadows, and identity from the source image. Keep the image sharp, lightly filmic, and non-stylized.`,
    negativePrompt: 'cartoon, CGI, anime, doll skin, over-smoothing, fake bokeh, extra furniture, wrong chair, wrong dress color, softbox beauty lighting, oversharpening, heavy vignette, face change',
    camera: 'Wide editorial composition with natural perspective and deep set readability',
    colorGrading: 'Soft vintage film grade with lifted blacks, gentle desaturation, and natural daylight neutrality.',
    faceRule: 'Preserve exact face and skin texture from reference; no beauty retouch or geometry drift.',
  },
  {
    id: 'oak_garden_bench_golden_hour',
    name: 'Oak Garden Bench Golden Hour',
    presetId: 'garden_oak_bench_golden_hour',
    vibe: 'Timeless, calm, introspective golden-hour garden portrait with soft stillness and natural detail.',
    scene: 'Peaceful garden with a centuries-old oak tree, weathered stone bench, layered foliage, and quiet late-afternoon atmosphere.',
    lighting: 'Golden afternoon sunlight filters through oak branches, casting intricate natural shadow patterns across the bench, dress, and skin. Warm light remains soft and realistic, with fine texture preserved in fabric and freckles.',
    poseNotes: 'Eye-level seated composition. Subject sits quietly on the stone bench holding a delicate teacup with relaxed hands and contemplative stillness. Weight and posture stay natural and unforced.',
    styleKeywords: ['garden', 'oak tree', 'stone bench', 'golden hour', 'quiet portrait', 'cream dress', 'natural texture'],
    fullPrompt: `Create a realistic eye-level portrait of the person from the reference image seated on a weathered stone bench beneath a large old oak tree in a peaceful garden. Preserve the exact identity from the reference. Golden afternoon sunlight filters through the branches, creating delicate shadow patterns across the scene. The subject wears a flowing cream dress and holds a small porcelain teacup with a calm, introspective posture. Keep skin texture, freckles, fabric weave, and foliage detail natural and believable. Avoid fantasy glow, fake haze, and synthetic background blur.`,
    negativePrompt: 'fantasy forest glow, overcooked golden filter, fake haze, synthetic blur, sticker effect, body reshape, beauty retouch, CGI foliage',
    camera: 'Eye-level seated environmental portrait with natural perspective',
    colorGrading: 'Warm late-afternoon neutrals with restrained gold highlights and realistic shadow contrast.',
    faceRule: 'Preserve exact face and body identity from reference with no beautification or reshaping.',
  },
  {
    id: 'indian_influencer_daylight',
    name: 'Indian Influencer Daylight',
    presetId: 'indian_influencer_daylight_fullbody',
    vibe: 'Premium but believable lifestyle influencer portrait in clean daylight.',
    scene: 'Uncluttered outdoor or lifestyle setting with soft depth, natural context, and premium everyday polish.',
    lighting: 'Soft natural daylight with gentle shadow shape and realistic highlight rolloff. Skin texture stays natural and non-plastic, and the background remains believable rather than stylized.',
    poseNotes: 'Full-body standing portrait with relaxed confident stance, natural hand placement, slight hip shift, and an easy expression. Keep weight distribution believable and avoid over-posed symmetry.',
    styleKeywords: ['indian influencer', 'full body', 'daylight', '85mm', 'pastel top', 'fitted jeans', 'lifestyle'],
    fullPrompt: `Create a realistic full-body daylight lifestyle portrait of the person from the reference image in a clean influencer-style setting. Preserve the exact same face, skin tone, body proportions, and identity from the source image. Wardrobe direction: light pastel top with fitted jeans, minimal elegant styling. Use soft natural daylight, 85mm DSLR-style framing, believable shallow depth, and high-detail skin texture with visible pores. Keep the image sharp, clean, and photorealistic without plastic skin, body reshaping, or fake influencer CGI polish.`,
    negativePrompt: 'plastic skin, body reshape, beauty filter symmetry, HDR halos, fake blur gradient, cartoon, anime, CGI, AI artifacts',
    camera: '85mm full-body DSLR portrait with believable shallow depth',
    colorGrading: 'Natural daylight with soft warm-neutral balance and restrained contrast.',
    faceRule: 'Identity lock absolute: same face, same body proportions, same skin tone, no beautification.',
  },
  {
    id: 'paris_eiffel_flash_night_ref',
    name: 'Paris Eiffel Flash Night',
    presetId: 'paris_eiffel_flash_night',
    vibe: 'Romantic night Paris portrait with hard flash realism and intimate cinematic atmosphere.',
    scene: 'Night Paris riverfront with stone parapet, Eiffel Tower glowing gold in the background, dark water, and boat reflections under a dark sky.',
    lighting: 'Direct hard flash on the seated subject mixed with warm tower glow and low ambient city light. Side light adds silhouette volume while keeping the scene grounded in real night exposure.',
    poseNotes: 'Seated facing camera on the stone parapet, legs relaxed and bent. Oversized red hoodie and loose gray jeans should drape naturally with authentic weight and folds.',
    styleKeywords: ['Paris night', 'Eiffel Tower', 'flash portrait', '85mm', 'river reflections', 'oversized hoodie'],
    fullPrompt: `Create an ultra-realistic night portrait of the person from the reference image seated on a stone parapet in Paris facing the camera. Preserve the exact identity from the second reference image. Wardrobe: oversized elongated red hoodie with very voluminous sleeves and loose gray baggy jeans. The Eiffel Tower glows warmly in the background with reflections in the dark water and boats visible behind. Use Canon EOS R5 style 85mm compression with hard direct flash on the subject plus subtle side light for volume. Keep skin, fabric, tower geometry, and water reflections realistic. Avoid poster-like HDR halos, fake postcard styling, and synthetic blur.`,
    negativePrompt: 'fake postcard Paris, overdone HDR, tower warp, synthetic blur, sticker edges, plastic skin, cartoon, CGI, beauty retouch',
    camera: 'Canon EOS R5 style 85mm night portrait with flash',
    colorGrading: 'Warm night golds against deep blacks with restrained cinematic grain and realistic contrast.',
    faceRule: 'Preserve exact identity from reference with no facial reshaping, beautification, or proportion drift.',
  },
  {
