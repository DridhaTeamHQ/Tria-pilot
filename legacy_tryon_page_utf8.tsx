        ...
        async function fetchIdentityImages() {
            ...
            try {
                ...
                if (normalized.length > 0) {
                    console.log(`≡ƒÄ¡ Loaded ${normalized.length} identity reference images`)
                }
            } catch (e) {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (useIdentityImages && identityImages.length > 0) {
                ...
                console.log(`≡ƒÄ¡ Adding ${identityForModel.length} identity references for better face consistency`)
        ...
        <div className="relative min-h-screen pt-24 pb-12 overflow-hidden bg-[#FDFBF7]">
            ...
            <div className="container mx-auto px-4 md:px-6 z-10 relative">
                ...
                <div className="mb-12">
                    ...
                    >
                        UPLOAD YOUR PHOTO ΓÇó SELECT CLOTHING ΓÇó SEE THE MAGIC
                    </motion.p>
                </div>
                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="text-[11px] text-charcoal/50 mt-1">
                                    Tip: for ΓÇ£Subtle PoseΓÇ¥ presets, add 1ΓÇô2 clear face photos to your profile for best face consistency.
                                </div>
                                            ...
                                            return (
                                                <>
                                                    ...
                                                    <p className="text-charcoal/60 text-sm mb-2">
                                                        {isOverEstimate
                                                            ? 'Γ£¿ Finishing up your images!'
                                                            : isAlmostDone
                                                                ? 'Γ£¿ Just a few more seconds!'
